...
def generate_pdf():
    ...
    elements.append(
        Paragraph(
            "<b>Disclaimer:</b> This report was generated by an educational/demo "
            "tool using simulated rule-based scoring, not a validated clinical model. "
            "It is not intended for real diagnostic or treatment decisions — always "
